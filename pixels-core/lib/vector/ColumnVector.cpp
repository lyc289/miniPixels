...
void ColumnVector::add(double value) {
    throw new std::runtime_error("Adding double is not supported");
}

void ColumnVector::add(float value) {
    throw new std::runtime_error("Adding float is not supported");
}
